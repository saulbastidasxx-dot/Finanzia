...
void main() {
  test('recurring alert id changes with the due month', () {
    ...
    final jan = FinancialAlertService()
        .build(s, now: DateTime(2026, 1, 1))
        .firstWhere((a) => a.kind == 'recurring');
    final feb = FinancialAlertService()
        .build(s, now: DateTime(2026, 2, 1))
        .firstWhere((a) => a.kind == 'recurring');
