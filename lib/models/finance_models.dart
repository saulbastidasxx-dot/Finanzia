...
class FinanceTransaction {
  ...
  final double amount;
  final String category, description, accountId;
  ...
  factory FinanceTransaction.fromJson(Map<String, dynamic> j) =>
      FinanceTransaction(
        ...
        destinationAccountId: j['destinationAccountId'],
...
class Debt {
  final String id, name;
  final double balance, apr, minimumPayment;
...
class RecurringPayment {
  final String id, name, category, accountId;
  final double amount;
  final int dayOfMonth;
  final bool isExpense, active;
